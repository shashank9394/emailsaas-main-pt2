...
const useVim = () => {
    ...
    const setUndone = api.account.setUndone.useMutation({
        onMutate: async (payload) => {
            ...
            const previousData = queryClient.getQueryData<RouterOutputs['account']['getThreads']>(queryKey)
            queryClient.setQueryData(queryKey, (data: RouterOutputs['account']['getThreads'] | undefined) => {
                if (!data) return data
